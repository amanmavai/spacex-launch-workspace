export function SpaceXCard(props) {
  ...
  return (
    <div className="bg-white rounded-lg p-6 m-2 w-56 text-sm" style={{height: '310px'}}>
      ...
      <div>
        <span className="font-semibold">Successful Launch: </span>
        {`${launch_success}`}
      </div>
      {launch_landing && (
        <div>
          <span className="font-semibold">Successful Landing: </span>
          {`${launch_landing}`}
        </div>
      )}
    </div>
